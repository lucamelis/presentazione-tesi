...
% titolo breve
\title[Implementazione di un protocollo Buyer-Seller]
% titolo esteso
 {\textbf{Implementazione di un protocollo Buyer-Seller basato su firme di gruppo}}
...
\begin{center}
	\begin{tabular}{cccccccc}
		...
		{\footnotesize Prof. Alessandro Piva} & & & & & & & {\footnotesize Ing. Tiziano Bianchi}\\
		{\footnotesize Prof. Alessandro Piva} & & & & & & & {\footnotesize Ing. Tiziano Bianchi}\\
	\end{tabular}
\end{center}
}
